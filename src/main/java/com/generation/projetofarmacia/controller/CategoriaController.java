...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>> getCategoriaByNome(@PathVariable String nome) {
	...
	@PutMapping
	public ResponseEntity<Categoria> editCategoria(@Valid @RequestBody Categoria categoria){
